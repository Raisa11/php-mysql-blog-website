            ...
            <?php
                              ...
                              <tbody>
                                ...
                                <?php
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <img src="img/post/<?php echo $thumbnail; ?>" width="100">
                                    </td>
                                    <td>
                                      <?php 
                                    ...
                                    <td>
                                      <div class="action-item">
                                        <ul>
                                          ...
                                          <li><a href="posts.php?upub=<?php echo $id;?>" title="unpublish post" style="color:#ff9900e3;"><i class="fas fa-arrow-down"></i></a>
                                             <li><a href="posts.php?pub=<?php echo $id;?>" title="publish post" style="color:#00801ce0;"><i class="fas fa-arrow-up"></i></a>

                                            <?php
                                            if(isset($_GET['upub'])){
                                              $the_id = $_GET['upub'];
                                              $query = " UPDATE post set status=0 WHERE id = '$the_id'";
                                               $pub = mysqli_query( $db, $query);
                                               if($pub){
                                            ...
                                            if(isset($_GET['pub'])){
                                              $the_id = $_GET['pub'];
                                              $query = " UPDATE post set status=1 WHERE id = '$the_id'";
                                               $pub = mysqli_query( $db, $query);
                                               if($pub){
                                                header('Location:posts.php?do=Manage');
                                               }
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Are You confirm to delete the Post?</h5>
                                          </div>
                                          <div class="modal-body">
                                            
                                              
                                            <a href="posts.php?do=Delete&delete=<?php echo $id; ?>" class="btn btn-primary">Yes</a>
              ...
              <?php }
                ...
                if ( $_SERVER['REQUEST_METHOD'] == 'POST' ){
                  ...
                  $query = "INSERT INTO post (title, description, thumbnail, category_id, user_id, status, post_date) VALUES( '$title', '$description', '$updatedimage', '$category_id', '$the_user_id', 1, now() )";
              ...
              // Update the Post
                ...
                if ( $_SERVER['REQUEST_METHOD'] == 'POST' ){
                  ...
                  if ( !empty($image) ){
                      ...
                      $query = "UPDATE post SET title='$title', description='$description', thumbnail='$updatedimage', category_id='$category_id', user_id='$the_user_id' WHERE id = '$the_post_id'";
              ...
              // Delete the Post
                ...
                if ( isset($_GET['delete']) ){
                  ...
                  // Delete the image form the Folder or Path
                  $query = "SELECT * FROM post WHERE id = '$the_id' ";
                  $find_image = mysqli_query($db, $query);
                  ...
                  $delete_the_post = "DELETE FROM post WHERE id = '$the_id' ";
                  $destroy_post = mysqli_query($db, $delete_the_post);
